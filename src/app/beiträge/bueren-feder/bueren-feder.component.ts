...
@Component({
  selector: 'app-bueren-feder',
  templateUrl: './bueren-feder.component.html',
  styleUrls: ['./bueren-feder.component.scss']
})
export class BuerenFederComponent implements OnInit {
