...
@Component({
  selector: 'app-trouvaillen-unsererfrauenbruderschaft',
  templateUrl: './trouvaillen-unsererfrauenbruderschaft.component.html',
  styleUrls: ['./trouvaillen-unsererfrauenbruderschaft.component.scss'],
})
export class TrouvaillenUnsererfrauenbruderschaftComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Rudolf Dellsperger',
