...
@Component({
  selector: 'app-stgallen-notkerglobus',
  templateUrl: './stgallen-notkerglobus.component.html',
  styleUrls: ['./stgallen-notkerglobus.component.scss'],
})
export class StgallenNotkerglobusComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Sophie Strauch',
