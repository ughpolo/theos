...
@Component({
  selector: 'app-aletschgletscher-arme-seelen',
  templateUrl: './aletschgletscher-arme-seelen.component.html',
  styleUrls: ['./aletschgletscher-arme-seelen.component.scss'],
})
export class AletschgletscherArmeSeelenComponent implements OnInit {
  ngOnInit(): void {
    this.assign('Andreas Weissen', 'Gletschersage');
    this.createIds();
  }
