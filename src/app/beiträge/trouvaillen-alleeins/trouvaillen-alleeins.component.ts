...
@Component({
  selector: 'app-trouvaillen-alleeins',
  templateUrl: './trouvaillen-alleeins.component.html',
  styleUrls: ['./trouvaillen-alleeins.component.scss'],
})
export class TrouvaillenAlleeinsComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Rudolf Dellsperger',
