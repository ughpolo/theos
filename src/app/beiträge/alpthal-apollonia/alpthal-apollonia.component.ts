...
@Component({
  selector: 'app-alpthal-apollonia',
  templateUrl: './alpthal-apollonia.component.html',
  styleUrls: ['./alpthal-apollonia.component.scss']
})
export class AlpthalApolloniaComponent implements OnInit {
