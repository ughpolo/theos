...
@Component({
  selector: 'app-undervelier-quellgrotte',
  templateUrl: './undervelier-quellgrotte.component.html',
  styleUrls: ['./undervelier-quellgrotte.component.scss'],
})
export class UndervelierQuellgrotteComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Janina Ammon',
