...
@Component({
  selector: 'app-bern-kindlifresserbrunnen',
  templateUrl: './bern-kindlifresserbrunnen.component.html',
  styleUrls: ['./bern-kindlifresserbrunnen.component.scss']
})
export class BernKindlifresserbrunnenComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.assign('René Bloch', 'Kindlifresserbrunnen');
    this.createIds();
  }
