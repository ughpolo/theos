...
@Component({
  selector: 'app-basel-martinskirche',
  templateUrl: './basel-martinskirche.component.html',
  styleUrls: ['./basel-martinskirche.component.scss']
})
export class BaselMartinskircheComponent implements OnInit {
