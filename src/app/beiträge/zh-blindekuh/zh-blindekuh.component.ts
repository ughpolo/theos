...
@Component({
  selector: 'app-zh-blindekuh',
  templateUrl: './zh-blindekuh.component.html',
  styleUrls: ['./zh-blindekuh.component.scss']
})
export class ZhBlindekuhComponent implements OnInit {
