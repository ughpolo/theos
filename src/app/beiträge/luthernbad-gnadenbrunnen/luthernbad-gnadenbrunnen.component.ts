...
@Component({
  selector: 'app-luthernbad-gnadenbrunnen',
  templateUrl: './luthernbad-gnadenbrunnen.component.html',
  styleUrls: ['./luthernbad-gnadenbrunnen.component.scss']
})
export class LuthernbadGnadenbrunnenComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.assign('Hans Herrmann', 'Gnadenbrunnen');
    this.createIds();
  }
