...
@Component({
  selector: 'app-windisch-das-amphitheater-vindonissa',
  templateUrl: './windisch-das-amphitheater-vindonissa.component.html',
  styleUrls: ['./windisch-das-amphitheater-vindonissa.component.scss'],
})
export class WindischDasAmphitheaterVindonissaComponent implements OnInit {
  ngOnInit(): void {
    this.assign('Tabea Stauffer', 'Das Amphitheater Vindonissa');
    this.createIds();
  }
