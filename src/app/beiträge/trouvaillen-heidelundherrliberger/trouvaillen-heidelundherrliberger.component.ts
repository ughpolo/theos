...
@Component({
  selector: 'app-trouvaillen-heidelundherrliberger',
  templateUrl: './trouvaillen-heidelundherrliberger.component.html',
  styleUrls: ['./trouvaillen-heidelundherrliberger.component.scss'],
})
export class TrouvaillenHeidelundherrlibergerComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Rudolf Dellsperger',
