...
@Component({
  selector: 'app-trouvaillen-montmirail',
  templateUrl: './trouvaillen-montmirail.component.html',
  styleUrls: ['./trouvaillen-montmirail.component.scss'],
})
export class TrouvaillenMontmirailComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Rudolf Dellsperger',
      'Thielle-Wavre (NE): Das alte Haus von Montmirail'
    );
    this.createIds();
  }
