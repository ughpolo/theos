...
@Component({
  selector: 'app-london-church',
  templateUrl: './london-church.component.html',
  styleUrls: ['./london-church.component.scss']
})
export class LondonChurchComponent implements OnInit {

  ngOnInit(): void {
    this.assign('Carla Maurer', 'Swiss Church in London');
    this.createIds();
  }
