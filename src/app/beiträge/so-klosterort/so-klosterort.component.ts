...
@Component({
  selector: 'app-so-klosterort',
  templateUrl: './so-klosterort.component.html',
  styleUrls: ['./so-klosterort.component.scss']
})
export class SoKlosterortComponent implements OnInit {
