...
@Component({
  selector: 'app-trouvaillen-buchhof',
  templateUrl: './trouvaillen-buchhof.component.html',
  styleUrls: ['./trouvaillen-buchhof.component.scss'],
})
export class TrouvaillenBuchhofComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Rudolf Dellsperger',
      'Buchhof (SO): "... damit die christliche Freiheit bleibe"'
    );
    this.createIds();
  }
