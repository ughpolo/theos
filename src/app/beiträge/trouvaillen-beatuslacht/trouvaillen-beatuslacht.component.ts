...
@Component({
  selector: 'app-trouvaillen-beatuslacht',
  templateUrl: './trouvaillen-beatuslacht.component.html',
  styleUrls: ['./trouvaillen-beatuslacht.component.scss'],
})
export class TrouvaillenBeatuslachtComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Rudolf Dellsperger',
