...
@Component({
  selector: 'app-glarus-simultaneum',

  templateUrl: './glarus-simultaneum.component.html',
  styleUrl: './glarus-simultaneum.component.scss',
})
export class GlarusSimultaneumComponent {
  ngOnInit(): void {
    this.assign(
      'Tamara Landolt',
