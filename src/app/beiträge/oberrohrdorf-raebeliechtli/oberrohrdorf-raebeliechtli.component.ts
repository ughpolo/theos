...
@Component({
  selector: 'app-oberrohrdorf-raebeliechtli',
  templateUrl: './oberrohrdorf-raebeliechtli.component.html',
  styleUrls: ['./oberrohrdorf-raebeliechtli.component.scss'],
})
export class OberrohrdorfRaebeliechtliComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Tabea Stauffer',
