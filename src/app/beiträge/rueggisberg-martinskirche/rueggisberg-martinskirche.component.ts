...
@Component({
  selector: 'app-rueggisberg-martinskirche',
  templateUrl: './rueggisberg-martinskirche.component.html',
  styleUrls: ['./rueggisberg-martinskirche.component.scss']
})
export class RueggisbergMartinskircheComponent implements OnInit {

  ngOnInit(): void {
    this.assign('Elisabeth Willen-Lanzrein', 'Martinskirche Rüeggisberg');
    this.createIds();
  }
