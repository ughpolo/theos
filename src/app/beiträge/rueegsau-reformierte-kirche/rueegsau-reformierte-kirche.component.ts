...
@Component({
  selector: 'app-rueegsau-reformierte-kirche',
  templateUrl: './rueegsau-reformierte-kirche.component.html',
  styleUrls: ['./rueegsau-reformierte-kirche.component.scss']
})
export class RueegsauReformierteKircheComponent implements OnInit {

  ngOnInit(): void {
    this.assign('Rolf Weibel', 'Reformierte Kirche');
    this.createIds();
}
