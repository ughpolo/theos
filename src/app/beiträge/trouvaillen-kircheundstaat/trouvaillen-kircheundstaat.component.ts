...
@Component({
  selector: 'app-trouvaillen-kircheundstaat',
  templateUrl: './trouvaillen-kircheundstaat.component.html',
  styleUrls: ['./trouvaillen-kircheundstaat.component.scss'],
})
export class TrouvaillenKircheundstaatComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Rudolf Dellsperger',
      'Bern, Kirche und Staat - ein Balanceakt'
    );
    this.createIds();
  }
