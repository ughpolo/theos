...
@Component({
  selector: 'app-basel-galluspforte',
  templateUrl: './basel-galluspforte.component.html',
  styleUrls: ['./basel-galluspforte.component.scss'],
})
export class BaselGalluspforteComponent implements OnInit {
  ngOnInit(): void {
    this.assign('Silvan Beer', 'Die Galluspforte am Basler Münster');
    this.createIds();
  }
