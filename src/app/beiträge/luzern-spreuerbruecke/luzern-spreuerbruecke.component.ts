...
@Component({
  selector: 'app-luzern-spreuerbruecke',
  templateUrl: './luzern-spreuerbruecke.component.html',
  styleUrls: ['./luzern-spreuerbruecke.component.scss']
})
export class LuzernSpreuerbrueckeComponent implements OnInit {


  ngOnInit(): void {
    this.assign('Sina von Aesch', 'Spreuerbrücke');
    this.createIds();
  }
