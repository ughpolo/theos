...
@Component({
  selector: 'app-oberdorf-wallfahrtskirche',
  templateUrl: './oberdorf-wallfahrtskirche.component.html',
  styleUrls: ['./oberdorf-wallfahrtskirche.component.scss'],
})
export class OberdorfWallfahrtskircheComponent implements OnInit {
  ngOnInit(): void {
    this.assign('Peter Widmer', 'Wallfahrtskirche Mariä Himmelfahrt');
    this.createIds();
  }
