...
@Component({
  selector: 'app-disentis-benediktinerkloster',
  templateUrl: './disentis-benediktinerkloster.component.html',
  styleUrls: ['./disentis-benediktinerkloster.component.scss'],
})
export class DisentisBenediktinerklosterComponent implements OnInit {
  ngOnInit(): void {
    this.assign('Jan Peter Lang', 'Benediktinerkloster');
    this.createIds();
  }
