...
@Component({
  selector: 'app-taenikon-klostertaenikon',

  templateUrl: './taenikon-klostertaenikon.component.html',
  styleUrl: './taenikon-klostertaenikon.component.scss',
})
export class TaenikonKlostertaenikonComponent {
  ngOnInit(): void {
    this.assign('Martin Brunner', 'Das Zisterzienserinnenkloster Tänikon');
    this.createIds();
  }
