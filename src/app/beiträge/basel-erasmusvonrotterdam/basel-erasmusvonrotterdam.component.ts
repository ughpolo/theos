...
@Component({
  selector: 'app-basel-erasmusvonrotterdam',
  templateUrl: './basel-erasmusvonrotterdam.component.html',
  styleUrls: ['./basel-erasmusvonrotterdam.component.scss'],
})
export class BaselErasmusvonrotterdamComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Andrea Flückiger',
