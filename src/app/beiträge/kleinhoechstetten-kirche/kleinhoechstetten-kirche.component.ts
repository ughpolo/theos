...
@Component({
  selector: 'app-kleinhoechstetten-kirche',
  templateUrl: './kleinhoechstetten-kirche.component.html',
  styleUrls: ['./kleinhoechstetten-kirche.component.scss'],
})
export class KleinhoechstettenKircheComponent implements OnInit {
  ngOnInit(): void {
    this.assign('Miriam Löhr', 'Die evangelisch-reformierte Kirche');
    this.createIds();
  }
