...
@Component({
  selector: 'app-trouvaillen-muenchenwilerchristusundkirche',
  templateUrl: './trouvaillen-muenchenwilerchristusundkirche.component.html',
  styleUrls: ['./trouvaillen-muenchenwilerchristusundkirche.component.scss'],
})
export class TrouvaillenMuenchenwilerchristusundkircheComponent
  implements OnInit
{
  ngOnInit(): void {
    this.assign(
