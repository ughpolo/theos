...
@Component({
  selector: 'app-gland-saint-jean-baptiste',
  templateUrl: './gland-saint-jean-baptiste.component.html',
  styleUrls: ['./gland-saint-jean-baptiste.component.scss'],
})
export class GlandSaintJeanBaptisteComponent implements OnInit {
  ngOnInit(): void {
    this.assign('David Zimmer', 'Église Saint-Jean-Baptiste');
    this.createIds();
  }
