...
@Component({
  selector: 'app-endingen-friedhof',
  templateUrl: './endingen-friedhof.component.html',
  styleUrls: ['./endingen-friedhof.component.scss']
})
export class EndingenFriedhofComponent implements OnInit {
...
pathname!: string;
  ...
  ngOnInit(): void {
    ...
    this.assign('René Bloch', 'Synagogen und Friedhof');
    this.createIds();
  }
