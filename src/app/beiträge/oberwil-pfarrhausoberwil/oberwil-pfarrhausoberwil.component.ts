...
@Component({
  selector: 'app-oberwil-pfarrhausoberwil',

  templateUrl: './oberwil-pfarrhausoberwil.component.html',
  styleUrl: './oberwil-pfarrhausoberwil.component.scss',
})
export class OberwilPfarrhausoberwilComponent {
  ngOnInit(): void {
    this.assign(
      'Jonas Engeler',
