...
@Component({
  selector: 'app-graubuenden-benediktinerkloster',
  templateUrl: './graubuenden-benediktinerkloster.component.html',
  styleUrls: ['./graubuenden-benediktinerkloster.component.scss']
})
export class GraubuendenBenediktinerklosterComponent implements OnInit {
  coordinates: any;
  ...
  ngOnInit(): void {
    ...
    this.assign('Dominik von Allmen', 'Feder');
    this.createIds();
  }
