...
@Component({
  selector: 'app-einsiedeln-madonna',
  templateUrl: './einsiedeln-madonna.component.html',
  styleUrls: ['./einsiedeln-madonna.component.scss']
})
export class EinsiedelnMadonnaComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.assign('Ulrike Münger', 'Schwarze Madonna');
    this.createIds();
  }
