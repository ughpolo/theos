...
@Component({
  selector: 'app-basel-marienkirche',
  templateUrl: './basel-marienkirche.component.html',
  styleUrls: ['./basel-marienkirche.component.scss'],
})
export class BaselMarienkircheComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Patrick Braun',
