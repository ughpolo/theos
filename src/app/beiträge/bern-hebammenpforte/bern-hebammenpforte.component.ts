...
@Component({
  selector: 'app-bern-hebammenpforte',
  templateUrl: './bern-hebammenpforte.component.html',
  styleUrls: ['./bern-hebammenpforte.component.scss']
})
export class BernHebammenpforteComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.assign('Adrienne Shannon Grossenbacher', 'Hebammenpforte des Berner Münsters');
    this.createIds();
  }
