...
@Component({
  selector: 'app-oberwil-hansarp',
  templateUrl: './oberwil-hansarp.component.html',
  styleUrls: ['./oberwil-hansarp.component.scss'],
})
export class OberwilHansarpComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Jonas Engeler',
