...
@Component({
  selector: 'app-gesteigwiler-wandmalereienundheiligkeit',
  templateUrl: './gesteigwiler-wandmalereienundheiligkeit.component.html',
  styleUrls: ['./gesteigwiler-wandmalereienundheiligkeit.component.scss'],
})
export class GesteigwilerWandmalereienundheiligkeitComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Joana Mayer',
