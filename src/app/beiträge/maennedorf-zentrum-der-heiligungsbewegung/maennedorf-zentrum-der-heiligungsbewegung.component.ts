...
@Component({
  selector: 'app-maennedorf-zentrum-der-heiligungsbewegung',
  templateUrl: './maennedorf-zentrum-der-heiligungsbewegung.component.html',
  styleUrls: ['./maennedorf-zentrum-der-heiligungsbewegung.component.scss'],
})
export class MaennedorfZentrumDerHeiligungsbewegungComponent implements OnInit {
  ngOnInit(): void {
    this.assign('Gergely Csukás', 'Zentrum der Heiligungsbewegung');
    this.createIds();
  }
