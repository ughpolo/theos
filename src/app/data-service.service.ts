...
export class DataServiceService {
  ...
  beiträge: Beitrag[] = [
    ...
    new Beitrag("das Kraftwerk Birsfelden", "Birsfelden", "../../../assets/images/birsfelden/birsfelden_kraftwerk.jpg", "Georg Kreis", "2020", "Basel"),
    ...
    new Beitrag("Scherzlingen Kirche", "Scherzlingen", "../../../assets/images/scherzlingen/scherzlingen.jpg", "Markus Nägeli", "2019", "Thun"),
