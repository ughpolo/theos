...
@Component({
  selector: 'app-trouvaillen-hindelbank',
  templateUrl: './trouvaillen-hindelbank.component.html',
  styleUrls: ['./trouvaillen-hindelbank.component.scss'],
})
export class TrouvaillenHindelbankComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Rudolf Dellsperger',
      'Hindelbank (BE): Es geht nicht alles zugrunde'
    );
    this.createIds();
  }
