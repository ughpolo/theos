...
@Component({
  selector: 'app-simplon-hospiz',
  templateUrl: './simplon-hospiz.component.html',
  styleUrls: ['./simplon-hospiz.component.scss']
})
export class SimplonHospizComponent implements OnInit {

  ngOnInit(): void {
    this.assign('Daniel Salzgeber', 'Simplon Hospiz');
    this.createIds();
  }
