...
@Component({
  selector: 'app-trouvaillen-herrengasse13',
  templateUrl: './trouvaillen-herrengasse13.component.html',
  styleUrls: ['./trouvaillen-herrengasse13.component.scss'],
})
export class TrouvaillenHerrengasse13Component implements OnInit {
  ngOnInit(): void {
    this.assign('Rudolf Dellsperger', 'Bern, Herrengasse 13: Hausspruch');
    this.createIds();
  }
