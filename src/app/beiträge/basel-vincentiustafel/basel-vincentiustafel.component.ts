...
@Component({
  selector: 'app-basel-vincentiustafel',
  templateUrl: './basel-vincentiustafel.component.html',
  styleUrls: ['./basel-vincentiustafel.component.scss']
})
export class BaselVincentiustafelComponent implements OnInit {
