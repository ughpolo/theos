...
@Component({
  selector: 'app-davos-marienkirche',

  templateUrl: './davos-marienkirche.component.html',
  styleUrl: './davos-marienkirche.component.scss',
})
export class DavosMarienkircheComponent {
  ngOnInit(): void {
    this.assign(
      'Petra Homberger',
