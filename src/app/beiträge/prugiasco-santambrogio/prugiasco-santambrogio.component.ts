...
@Component({
  selector: 'app-prugiasco-santambrogio',
  templateUrl: './prugiasco-santambrogio.component.html',
  styleUrls: ['./prugiasco-santambrogio.component.scss'],
})
export class PrugiascoSantambrogioComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Jonathan Stutz',
      'Sant´Ambrogio vecchio (San Carlo di Negrentino)'
    );
    this.createIds();
  }
