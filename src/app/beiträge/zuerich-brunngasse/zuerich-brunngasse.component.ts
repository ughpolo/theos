...
@Component({
  selector: 'app-zuerich-brunngasse',

  templateUrl: './zuerich-brunngasse.component.html',
  styleUrl: './zuerich-brunngasse.component.scss',
})
export class ZuerichBrunngasseComponent {
  ngOnInit(): void {
    this.assign(
      'Dölf Wild',
