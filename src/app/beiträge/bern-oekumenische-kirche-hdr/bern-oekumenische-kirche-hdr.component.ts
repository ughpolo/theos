...
@Component({
  selector: 'app-bern-oekumenische-kirche-hdr',
  templateUrl: './bern-oekumenische-kirche-hdr.component.html',
  styleUrls: ['./bern-oekumenische-kirche-hdr.component.scss'],
})
export class BernOekumenischeKircheHdrComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Angela Büchel Sladkovic, Frieder Vollprecht, Christian Walti ',
      'Ökumenische Kirche im Haus der Religionen'
    );
    this.createIds();
  }
