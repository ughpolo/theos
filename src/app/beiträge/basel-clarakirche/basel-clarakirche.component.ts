...
@Component({
  selector: 'app-basel-clarakirche',
  templateUrl: './basel-clarakirche.component.html',
  styleUrls: ['./basel-clarakirche.component.scss'],
})
export class BaselClarakircheComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Patrick Braun',
