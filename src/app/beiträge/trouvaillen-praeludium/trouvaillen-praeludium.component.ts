...
@Component({
  selector: 'app-trouvaillen-praeludium',
  templateUrl: './trouvaillen-praeludium.component.html',
  styleUrls: ['./trouvaillen-praeludium.component.scss']
})
export class TrouvaillenPraeludiumComponent implements OnInit {

  ngOnInit(): void {
    this.assign('Rudolf Dellsberger', '0 Präludium: «Man muss sie spielen …» ');
    this.createIds();
}
