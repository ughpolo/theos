...
@Component({
  selector: 'app-davos-marienkirchedavos',

  templateUrl: './davos-marienkirchedavos.component.html',
  styleUrl: './davos-marienkirchedavos.component.scss',
})
export class DavosMarienkirchedavosComponent {
  ngOnInit(): void {
    this.assign(
      'Petra Homberger',
