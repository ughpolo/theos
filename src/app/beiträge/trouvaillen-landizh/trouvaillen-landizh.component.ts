...
@Component({
  selector: 'app-trouvaillen-landizh',
  templateUrl: './trouvaillen-landizh.component.html',
  styleUrls: ['./trouvaillen-landizh.component.scss'],
})
export class TrouvaillenLandizhComponent implements OnInit {
  ngOnInit(): void {
    this.assign('Rudolf Dellsperger', 'Zürich, Landesausstellung: Ganz Ohr');
    this.createIds();
  }
