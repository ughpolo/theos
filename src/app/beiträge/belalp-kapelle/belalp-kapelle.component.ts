...
@Component({
  selector: 'app-belalp-kapelle',
  templateUrl: './belalp-kapelle.component.html',
  styleUrls: ['./belalp-kapelle.component.scss']
})
export class BelalpKapelleComponent implements OnInit {
  ...
  ngOnInit(): void {
    /*Autor,          */
    this.assign('Gerd Dönni', 'Kapelle');
    this.createIds();
  }
