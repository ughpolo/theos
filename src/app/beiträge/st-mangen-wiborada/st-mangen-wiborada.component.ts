...
@Component({
  selector: 'app-st-mangen-wiborada',
  templateUrl: './st-mangen-wiborada.component.html',
  styleUrls: ['./st-mangen-wiborada.component.scss'],
})
export class StMangenWiboradaComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Ann-Katrin Gässlein',
