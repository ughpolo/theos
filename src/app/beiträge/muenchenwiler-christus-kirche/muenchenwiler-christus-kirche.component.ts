...
@Component({
  selector: 'app-muenchenwiler-christus-kirche',
  templateUrl: './muenchenwiler-christus-kirche.component.html',
  styleUrls: ['./muenchenwiler-christus-kirche.component.scss'],
})
export class MuenchenwilerChristusKircheComponent implements OnInit {
  ngOnInit(): void {
    this.assign('Rudolf Dellsperger', '1 Christus und die Kirche');
    this.createIds();
  }
