...
@Component({
  selector: 'app-trouvaillen-heidelbergerundherrliberger',
  templateUrl: './trouvaillen-heidelbergerundherrliberger.component.html',
  styleUrls: ['./trouvaillen-heidelbergerundherrliberger.component.scss'],
})
export class TrouvaillenHeidelbergerundherrlibergerComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Rudolf Dellsperger',
