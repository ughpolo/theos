...
@Component({
  selector: 'app-sulzig-weitblick',
  templateUrl: './sulzig-weitblick.component.html',
  styleUrls: ['./sulzig-weitblick.component.scss']
})
export class SulzigWeitblickComponent implements OnInit {

  ngOnInit(): void {
    this.assign('Gregor Emmenegger, David Neuhold, Anton Schwingruber', 'Weitblick und Enge');
    this.createIds();
  }
