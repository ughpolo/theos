...
@Component({
  selector: 'app-zuerich-heiligungsbewegung',
  templateUrl: './zuerich-heiligungsbewegung.component.html',
  styleUrls: ['./zuerich-heiligungsbewegung.component.scss']
})
export class ZuerichHeiligungsbewegungComponent implements OnInit {
