...
@Component({
  selector: 'app-trouvaillen-unsertaeglichbrot',
  templateUrl: './trouvaillen-unsertaeglichbrot.component.html',
  styleUrls: ['./trouvaillen-unsertaeglichbrot.component.scss'],
})
export class TrouvaillenUnsertaeglichbrotComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Rudolf Dellsperger',
