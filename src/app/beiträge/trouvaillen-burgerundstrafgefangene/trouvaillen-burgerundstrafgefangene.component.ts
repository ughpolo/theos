...
@Component({
  selector: 'app-trouvaillen-burgerundstrafgefangene',
  templateUrl: './trouvaillen-burgerundstrafgefangene.component.html',
  styleUrls: ['./trouvaillen-burgerundstrafgefangene.component.scss'],
})
export class TrouvaillenBurgerundstrafgefangeneComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Rudolf Dellsperger',
      'Bern, Heiliggeistkirche: Für Burger und Strafgefangene'
    );
    this.createIds();
  }
