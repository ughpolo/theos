...
@Component({
  selector: 'app-trouvaillen-daerstetten',
  templateUrl: './trouvaillen-daerstetten.component.html',
  styleUrls: ['./trouvaillen-daerstetten.component.scss'],
})
export class TrouvaillenDaerstettenComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Rudolf Dellsperger',
      'Därstetten (BE): "Almosen geben armet nid"'
    );
    this.createIds();
  }
