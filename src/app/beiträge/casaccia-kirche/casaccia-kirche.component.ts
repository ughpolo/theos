...
@Component({
  selector: 'app-casaccia-kirche',

  templateUrl: './casaccia-kirche.component.html',
  styleUrl: './casaccia-kirche.component.scss',
})
export class CasacciaKircheComponent {
  ngOnInit(): void {
    this.assign('Lukas Wüst', 'Die Legende des kopflosen Wanderers');
    this.createIds();
  }
