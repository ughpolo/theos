...
@Component({
  selector: 'app-freiburg-centre-dorient',
  templateUrl: './freiburg-centre-dorient.component.html',
  styleUrls: ['./freiburg-centre-dorient.component.scss']
})
export class FreiburgCentreDorientComponent implements OnInit {
...
pathname!: string;
  ...
  ngOnInit(): void {
    this.assign('Stefan Constantinescu', 'Centre d’études des Églises d’Orient');
    this.createIds();
  }
