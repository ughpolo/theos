...
@Component({
  selector: 'app-zuerich-blindekuh',
  templateUrl: './zuerich-blindekuh.component.html',
  styleUrls: ['./zuerich-blindekuh.component.scss']
})
export class ZuerichBlindekuhComponent implements OnInit {

  ngOnInit(): void {
    this.assign('Christoph Sigrist', 'Restaurant Blinde Kuh');
    this.createIds();
  }
