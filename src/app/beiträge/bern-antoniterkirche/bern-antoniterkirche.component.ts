...
@Component({
  selector: 'app-bern-antoniterkirche',
  templateUrl: './bern-antoniterkirche.component.html',
  styleUrls: ['./bern-antoniterkirche.component.scss']
})
export class BernAntoniterkircheComponent implements OnInit {
  ...
  ngOnInit(): void {
    /*Autor,          */
    this.assign('Nadja Heimlicher', 'Antoniterkirche');
    this.createIds();
  }
