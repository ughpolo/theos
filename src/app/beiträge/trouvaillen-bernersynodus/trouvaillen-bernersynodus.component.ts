...
@Component({
  selector: 'app-trouvaillen-bernersynodus',
  templateUrl: './trouvaillen-bernersynodus.component.html',
  styleUrls: ['./trouvaillen-bernersynodus.component.scss'],
})
export class TrouvaillenBernersynodusComponent implements OnInit {
  ngOnInit(): void {
    this.assign('Rudolf Dellsperger', 'Oberdiessbach (BE): Der Berner Synodus');
    this.createIds();
  }
