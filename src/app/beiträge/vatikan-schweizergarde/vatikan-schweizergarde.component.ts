...
@Component({
  selector: 'app-vatikan-schweizergarde',
  templateUrl: './vatikan-schweizergarde.component.html',
  styleUrls: ['./vatikan-schweizergarde.component.scss'],
})
export class VatikanSchweizergardeComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Tabea Stauffer',
