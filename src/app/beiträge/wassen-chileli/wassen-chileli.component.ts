...
@Component({
  selector: 'app-wassen-chileli',

  templateUrl: './wassen-chileli.component.html',
  styleUrl: './wassen-chileli.component.scss',
})
export class WassenChileliComponent {
  ngOnInit(): void {
    this.assign('Tobias Briker', '«Chileli vo Wasse»');
    this.createIds();
  }
