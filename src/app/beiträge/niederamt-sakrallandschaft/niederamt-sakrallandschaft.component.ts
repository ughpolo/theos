...
@Component({
  selector: 'app-niederamt-sakrallandschaft',
  templateUrl: './niederamt-sakrallandschaft.component.html',
  styleUrls: ['./niederamt-sakrallandschaft.component.scss'],
})
export class NiederamtSakrallandschaftComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'David Zimmer',
