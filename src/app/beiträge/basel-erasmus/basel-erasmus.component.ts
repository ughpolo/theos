...
@Component({
  selector: 'app-basel-erasmus',
  templateUrl: './basel-erasmus.component.html',
  styleUrls: ['./basel-erasmus.component.scss'],
})
export class BaselErasmusComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Beate Heiniger',
