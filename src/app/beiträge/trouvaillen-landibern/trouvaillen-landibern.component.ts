...
@Component({
  selector: 'app-trouvaillen-landibern',
  templateUrl: './trouvaillen-landibern.component.html',
  styleUrls: ['./trouvaillen-landibern.component.scss'],
})
export class TrouvaillenLandibernComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Rudolf Dellsperger',
      'Bern, Landesausstellung 1914: Gottesfremde'
    );
    this.createIds();
  }
