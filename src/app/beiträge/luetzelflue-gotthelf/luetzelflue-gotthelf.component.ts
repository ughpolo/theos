...
@Component({
  selector: 'app-luetzelflue-gotthelf',
  templateUrl: './luetzelflue-gotthelf.component.html',
  styleUrls: ['./luetzelflue-gotthelf.component.scss'],
})
export class LuetzelflueGotthelfComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Daniel N. Herrmann',
