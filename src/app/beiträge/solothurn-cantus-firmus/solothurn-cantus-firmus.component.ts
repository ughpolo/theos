...
@Component({
  selector: 'app-solothurn-cantus-firmus',
  templateUrl: './solothurn-cantus-firmus.component.html',
  styleUrls: ['./solothurn-cantus-firmus.component.scss'],
})
export class SolothurnCantusFirmusComponent implements OnInit {
  ngOnInit(): void {
    this.assign('Adriana Basso Schaub', 'Kunstprojekt Cantus firmus');
    this.createIds();
  }
