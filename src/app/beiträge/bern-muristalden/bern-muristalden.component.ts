...
@Component({
  selector: 'app-bern-muristalden',
  templateUrl: './bern-muristalden.component.html',
  styleUrls: ['./bern-muristalden.component.scss'],
})
export class BernMuristaldenComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Meriel Lannutti',
