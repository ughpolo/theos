...
@Component({
  selector: 'app-trouvaillen-inspeetsilentio',
  templateUrl: './trouvaillen-inspeetsilentio.component.html',
  styleUrls: ['./trouvaillen-inspeetsilentio.component.scss'],
})
export class TrouvaillenInspeetsilentioComponent implements OnInit {
  ngOnInit(): void {
    this.assign('Rudolf Dellsperger', '"IN SPE ET SILENTIO"');
    this.createIds();
  }
