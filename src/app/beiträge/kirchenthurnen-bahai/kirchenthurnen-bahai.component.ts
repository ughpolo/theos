...
@Component({
  selector: 'app-kirchenthurnen-bahai',
  templateUrl: './kirchenthurnen-bahai.component.html',
  styleUrls: ['./kirchenthurnen-bahai.component.scss']
})
export class KirchenthurnenBahaiComponent implements OnInit {

  ngOnInit(): void {
    this.assign('Ruth Merz', 'Tempelland der Schweizer Bahai-Gemeinde');
    this.createIds();
}
