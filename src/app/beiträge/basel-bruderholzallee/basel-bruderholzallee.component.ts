...
@Component({
  selector: 'app-basel-bruderholzallee',

  templateUrl: './basel-bruderholzallee.component.html',
  styleUrl: './basel-bruderholzallee.component.scss',
})
export class BaselBruderholzalleeComponent {
  ngOnInit(): void {
    this.assign(
      'Albrecht Grözinger',
