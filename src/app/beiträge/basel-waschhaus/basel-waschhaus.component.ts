...
@Component({
  selector: 'app-basel-waschhaus',
  templateUrl: './basel-waschhaus.component.html',
  styleUrls: ['./basel-waschhaus.component.scss'],
})
export class BaselWaschhausComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Patrick Braun',
