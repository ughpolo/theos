...
@Component({
  selector: 'app-erlenbach-sankt-michaelskirche',
  templateUrl: './erlenbach-sankt-michaelskirche.component.html',
  styleUrls: ['./erlenbach-sankt-michaelskirche.component.scss'],
})
export class ErlenbachSanktMichaelskircheComponent implements OnInit {
  ngOnInit(): void {
    this.assign('Hans Hofer', 'Sankt Michaelskirche');
    this.createIds();
  }
