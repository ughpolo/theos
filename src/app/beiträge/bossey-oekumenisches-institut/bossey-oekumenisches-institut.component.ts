...
@Component({
  selector: 'app-bossey-oekumenisches-institut',
  templateUrl: './bossey-oekumenisches-institut.component.html',
  styleUrls: ['./bossey-oekumenisches-institut.component.scss']
})
export class BosseyOekumenischesInstitutComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.assign('David Zimmer', 'Ökumenisches Institut');
    this.createIds();
  }
