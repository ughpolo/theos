...
@Component({
  selector: 'app-trouvaillen-mattelaendtetor',
  templateUrl: './trouvaillen-mattelaendtetor.component.html',
  styleUrls: ['./trouvaillen-mattelaendtetor.component.scss'],
})
export class TrouvaillenMattelaendtetorComponent implements OnInit {
  ngOnInit(): void {
    this.assign('Rudolf Dellsperger', 'Bern, Matte: Ländtetor');
    this.createIds();
  }
