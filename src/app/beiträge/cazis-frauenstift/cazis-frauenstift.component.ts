...
@Component({
  selector: 'app-cazis-frauenstift',

  templateUrl: './cazis-frauenstift.component.html',
  styleUrl: './cazis-frauenstift.component.scss',
})
export class CazisFrauenstiftComponent {
  ngOnInit(): void {
    this.assign(
      'Deborah Koch',
