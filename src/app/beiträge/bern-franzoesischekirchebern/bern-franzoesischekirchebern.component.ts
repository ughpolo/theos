...
@Component({
  selector: 'app-bern-franzoesischekirchebern',

  templateUrl: './bern-franzoesischekirchebern.component.html',
  styleUrl: './bern-franzoesischekirchebern.component.scss',
})
export class BernFranzoesischekirchebernComponent {
  ngOnInit(): void {
    this.assign('Naemi Zürcher', 'Klosterleben in der Französischen Kirche');
    this.createIds();
  }
