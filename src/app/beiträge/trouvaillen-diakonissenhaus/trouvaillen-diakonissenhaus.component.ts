...
@Component({
  selector: 'app-trouvaillen-diakonissenhaus',
  templateUrl: './trouvaillen-diakonissenhaus.component.html',
  styleUrls: ['./trouvaillen-diakonissenhaus.component.scss'],
})
export class TrouvaillenDiakonissenhausComponent implements OnInit {
  ngOnInit(): void {
    this.assign(
      'Rudolf Dellsperger',
      'Bern West: Vom Zeughaus zum Diakonissenhaus'
    );
    this.createIds();
  }
