...
@Component({
  selector: 'app-pleif-taldeslichts',

  templateUrl: './pleif-taldeslichts.component.html',
  styleUrl: './pleif-taldeslichts.component.scss',
})
export class PleifTaldeslichtsComponent {
  ngOnInit(): void {
    this.assign('Ralph Kunz', 'Im Tal des Lichts');
    this.createIds();
  }
