...
@Component({
  selector: 'app-st-gallen-einmauern',
  templateUrl: './st-gallen-einmauern.component.html',
  styleUrls: ['./st-gallen-einmauern.component.scss'],
})
export class StGallenEinmauernComponent implements OnInit {
  ngOnInit(): void {
    this.assign('Andrea Mösching', 'Einmal einmauern, bitte.');
    this.createIds();
  }
