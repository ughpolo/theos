...
@Component({
  selector: 'app-finsteraarhorn-gipfelkreuz',

  templateUrl: './finsteraarhorn-gipfelkreuz.component.html',
  styleUrl: './finsteraarhorn-gipfelkreuz.component.scss',
})
export class FinsteraarhornGipfelkreuzComponent {
  ngOnInit(): void {
    this.assign(
