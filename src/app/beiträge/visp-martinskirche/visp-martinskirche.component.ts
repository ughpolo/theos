...
@Component({
  selector: 'app-visp-martinskirche',
  templateUrl: './visp-martinskirche.component.html',
  styleUrls: ['./visp-martinskirche.component.scss']
})
export class VispMartinskircheComponent implements OnInit {

  ngOnInit(): void {
    this.assign('Damian Pfammatter', 'St. Martinskirche Visp');
    this.createIds();
}
