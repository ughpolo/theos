...
@Component({
  selector: 'app-trouvaillen-christusunddiekirche',
  templateUrl: './trouvaillen-christusunddiekirche.component.html',
  styleUrls: ['./trouvaillen-christusunddiekirche.component.scss']
})
export class TrouvaillenChristusunddiekircheComponent implements OnInit {

  ngOnInit(): void {
    this.assign('Rudolf Dellsberger', '1 Christus und die Kirche');
    this.createIds();
}
